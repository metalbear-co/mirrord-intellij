...
class BazelBinaryProvider241(
    var env: ExecutionEnvironment,
) : BazelBinaryProvider {
    class BinaryExecutionPlan241(
        val state: Any,
        private val binaryToPatch: String?,
    ) : BinaryExecutionPlan {
        ...
        override fun getBinaryToPatch(): String? = binaryToPatch
    ...
    override fun getBinaryExecPlanClass(): KClass<out BinaryExecutionPlan> = BinaryExecutionPlan241::class
}
