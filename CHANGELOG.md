...
## [3.77.0](https://github.com/metalbear-co/mirrord-intellij/tree/3.77.0) - 2026-06-06
...
- Aligned mirrord binary resolution (and auto-update, etc) with the VSCode
  plugin. Furthermore, introduced custom mirrord binary paths as an option in
  settings.
...
- Added dropdown menu action that redirects to the plugin docs.
  [#316](https://github.com/metalbear-co/mirrord-intellij/issues/316)
